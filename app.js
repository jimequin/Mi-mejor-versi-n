...
const NUTRITION_DB = [
  ...
  // Ampliación general (todo lo que ya tenías en el Diario de comidas,
  // aquí también, por si algún día cambias un ingrediente del Menú por
  // alguno de estos). Los nombres específicos evitan a propósito
  // palabras que ya usa otra entrada de arriba (p.ej. "pechuga de pavo"
  // en vez de "pavo" a secas, que chocaría con "pavo picado").
  { keys: ['pechuga de pavo'], kcal: 135, p: 30, c: 0, f: 1 },
  { keys: ['gambas', 'langostinos'], kcal: 99, p: 24, c: 0.2, f: 0.3 },
  { keys: ['jamon de pavo', 'jamón de pavo', 'jamon cocido', 'jamón cocido'], kcal: 104, p: 17, c: 1, f: 3 },
  { keys: ['jamon serrano', 'jamón serrano'], kcal: 241, p: 31, c: 0, f: 13 },
  { keys: ['chorizo'], kcal: 455, p: 24, c: 1.9, f: 38 },
  { keys: ['arroz integral'], kcal: 123, p: 2.7, c: 25.8, f: 1 },
  { keys: ['pasta integral', 'pasta cocida'], kcal: 124, p: 5, c: 25, f: 1.1 },
  { keys: ['patata'], kcal: 87, p: 1.9, c: 20, f: 0.1 },
  { keys: ['pan integral'], kcal: 247, p: 13, c: 41, f: 3.4 },
  { keys: ['pan blanco'], kcal: 265, p: 9, c: 49, f: 3.2 },
  { keys: ['judias verdes', 'judías verdes'], kcal: 31, p: 1.8, c: 7, f: 0.1 },
  { keys: ['esparrago', 'espárrago'], kcal: 20, p: 2.2, c: 3.9, f: 0.1 },
  { keys: ['aceite de oliva'], kcal: 884, p: 0, c: 0, f: 100 },
  { keys: ['mozzarella'], kcal: 280, p: 22, c: 2.2, f: 21 },
  { keys: ['yogur natural'], kcal: 61, p: 3.5, c: 4.7, f: 3.3 },
  { keys: ['yogur griego'], kcal: 97, p: 9, c: 4, f: 5 },
  { keys: ['manzana'], kcal: 52, p: 0.3, c: 14, f: 0.2 },
  { keys: ['frutos secos'], kcal: 607, p: 20, c: 20, f: 54 },
  { keys: ['aguacate'], kcal: 160, p: 2, c: 9, f: 15 },
  { keys: ['leche semidesnatada'], kcal: 46, p: 3.3, c: 4.9, f: 1.6 },
  { keys: ['leche entera'], kcal: 61, p: 3.2, c: 4.8, f: 3.3 },
  { keys: ['bacon', 'panceta'], kcal: 541, p: 37, c: 1.4, f: 42 },
  { keys: ['calamar'], kcal: 92, p: 15, c: 3.1, f: 1.4 },
  { keys: ['mejillon', 'mejillón'], kcal: 86, p: 12, c: 3.7, f: 2.2 },
  { keys: ['cereales de desayuno'], kcal: 380, p: 7, c: 84, f: 1.5 },
  { keys: ['naranja'], kcal: 47, p: 0.9, c: 12, f: 0.1 },
  { keys: ['fresas', 'fresa'], kcal: 32, p: 0.7, c: 7.7, f: 0.3 },
  { keys: ['uvas', 'uva'], kcal: 69, p: 0.7, c: 18, f: 0.2 },
  { keys: ['mantequilla'], kcal: 717, p: 0.9, c: 0.1, f: 81 },
  { keys: ['mayonesa'], kcal: 680, p: 1, c: 2, f: 75 },
  { keys: ['chocolate negro'], kcal: 598, p: 7.8, c: 46, f: 43 },
...
const PRECIO_DB = [
  ...
  { keys: ['pechuga de pavo'], label: 'Pechuga de pavo', eur100g: 0.9, store: 'Mercadona' },
  { keys: ['gambas', 'langostinos'], label: 'Gambas/langostinos', eur100g: 1.9, store: 'Mercadona' },
  { keys: ['jamon de pavo', 'jamón de pavo', 'jamon cocido', 'jamón cocido'], label: 'Jamón de pavo/cocido', eur100g: 0.5, store: 'Mercadona' },
  { keys: ['jamon serrano', 'jamón serrano'], label: 'Jamón serrano', eur100g: 1.4, store: 'Mercadona' },
  { keys: ['chorizo'], label: 'Chorizo', eur100g: 1.1, store: 'Mercadona' },
  { keys: ['arroz integral'], label: 'Arroz integral', eur100g: 0.2, store: 'Mercadona' },
  { keys: ['pasta integral', 'pasta cocida'], label: 'Pasta integral', eur100g: 0.25, store: 'Mercadona' },
  { keys: ['patata'], label: 'Patata', eur100g: 0.1, store: 'Mercadona' },
  { keys: ['pan integral'], label: 'Pan integral', eur100g: 0.3, store: 'Mercadona' },
  { keys: ['pan blanco'], label: 'Pan blanco', eur100g: 0.2, store: 'Mercadona' },
  { keys: ['judias verdes', 'judías verdes'], label: 'Judías verdes', eur100g: 0.35, store: 'Mercadona' },
  { keys: ['esparrago', 'espárrago'], label: 'Espárragos', eur100g: 0.5, store: 'Mercadona' },
  { keys: ['aceite de oliva'], label: 'Aceite de oliva', eur100g: 0.9, store: 'Mercadona' },
  { keys: ['mozzarella'], label: 'Mozzarella', eur100g: 1.1, store: 'Mercadona' },
  { keys: ['yogur natural'], label: 'Yogur natural', eurUd: 0.3, store: 'Mercadona' },
  { keys: ['yogur griego'], label: 'Yogur griego', eurUd: 0.4, store: 'Mercadona' },
  { keys: ['manzana'], label: 'Manzana', eur100g: 0.2, store: 'Mercadona' },
  { keys: ['frutos secos'], label: 'Frutos secos (mix)', eur100g: 1.4, store: 'Carrefour Express' },
  { keys: ['aguacate'], label: 'Aguacate', eurUd: 0.8, store: 'Mercadona' },
  { keys: ['leche semidesnatada'], label: 'Leche semidesnatada', eur100g: 0.09, store: 'Mercadona' },
  { keys: ['leche entera'], label: 'Leche entera', eur100g: 0.09, store: 'Mercadona' },
  { keys: ['bacon', 'panceta'], label: 'Bacon/panceta', eur100g: 1.2, store: 'Mercadona' },
  { keys: ['calamar'], label: 'Calamares', eur100g: 1.5, store: 'Mercadona' },
  { keys: ['mejillon', 'mejillón'], label: 'Mejillones', eur100g: 0.9, store: 'Mercadona' },
  { keys: ['cereales de desayuno'], label: 'Cereales de desayuno', eur100g: 0.4, store: 'Mercadona' },
  { keys: ['naranja'], label: 'Naranja', eur100g: 0.15, store: 'Mercadona' },
  { keys: ['fresas', 'fresa'], label: 'Fresas', eur100g: 0.4, store: 'Mercadona' },
  { keys: ['uvas', 'uva'], label: 'Uvas', eur100g: 0.3, store: 'Mercadona' },
  { keys: ['mantequilla'], label: 'Mantequilla', eur100g: 0.9, store: 'Mercadona' },
  { keys: ['mayonesa'], label: 'Mayonesa', eur100g: 0.5, store: 'Mercadona' },
  { keys: ['chocolate negro'], label: 'Chocolate negro', eur100g: 1.2, store: 'Mercadona' },
